...
INPUT_FOLDER = "/data/hilinemised_peatuste_vahel"
OUTPUT_IMAGE = "seasonal_only_delay_comparison.png"
...
for filename in os.listdir(INPUT_FOLDER):
    ...
    try:
        ...
        df = df[(df['delay_minutes'] > 0) & (df['delay_minutes'] <= 15)]  # eemaldame ekstreemsed väärtused
...
summary = pd.DataFrame([
    {
        ...
        '12.06–27.08': round(sum(values['12.06–27.08']) / len(values['12.06–27.08']), 2) if values['12.06–27.08'] else None,
